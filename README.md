...
- [Dashboard (Metabase): Northwind dataset](https://github.com/MichlF/projects/tree/main/data_science/database_dashboard): Interactive dashboard for analyzing the Northwind database using *AWS* *RDS* & *EC2*, *PostgreSQL* and *Metabase*.
- [Dashboard (Streamlit): HR dataset](https://github.com/MichlF/projects/tree/main/data_science/hr_dashboard): A simple Streamlit dashboard visualizing an HR dataset using *Streamlit* and *Plotly*.
